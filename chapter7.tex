...
\end{figure}
\\
We have described the results of simulations in two different tasks, having good performances controlling the robot in both situations. The controller has been tested and appears to behaves stabilizing the system even in passing from one cost function to the other one.
