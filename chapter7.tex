...
\section{Physical experiments results}
	...
	\begin{itemize}
	\item The accuracy in measuring base position and orientation is highly dependent on the velocity of the base given that measures are taken from the encoders of the wheels
