...
\fix{metterei le relazioni per ricavare x,y theta dagli encoder}
...
\makebox[\textwidth][c]{\includegraphics[scale=0.3]{nodegraph2}}
\centering
...
\begin{figure}[h!]
	...
	\makebox[\textwidth][c]{\includegraphics[scale=0.4]{diagramreal}}
	\centering
