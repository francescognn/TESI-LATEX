...
The constraints will be defined in order to limitate unfeasible set of joint space as well as acceleration and speed limits of the state. in particular we will define: 

\begin{itemize}

\item  state constraints

\item control input constraints
